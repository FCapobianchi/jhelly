...
class DeviceFormFactory {
    ...
    public function default(): Form {
        $arraySchema = ["switch1"=>"switch1","switch25"=>"switch25","WallDisplay"=>"WallDisplay","Mini1G3"=>"Mini1G3"];
        $form = new Form();
        ...
        $form->addSelect('apiSchema',"API Schema",$arraySchema)->setPrompt("Select api schema")->setRequired(true)->setHtmlAttribute("class","form-control");
