<?php
// source: /home/fabiano/Sviluppo/jhelly.juice/config/common.neon
// source: /home/fabiano/Sviluppo/jhelly.juice/config/services.neon
// source: array
...
class Container_d1282aa377 extends Nette\DI\Container
{
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			'default',
			new Nette\Assets\ViteMapper(
			rtrim($baseUrl->resolve('assets')->getAbsoluteUrl(), '/'),
			$path = rtrim(Nette\Utils\FileSystem::resolvePath('/home/fabiano/Sviluppo/jhelly.juice/www', 'assets'), '\/'),
			null,
			null,
			new Nette\Assets\FilesystemMapper(
			rtrim($baseUrl->resolve('assets')->getAbsoluteUrl(), '/'),
			rtrim(Nette\Utils\FileSystem::resolvePath('/home/fabiano/Sviluppo/jhelly.juice/www', 'assets'), '\/'),
			[],
			true,
		),
		),
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/fabiano/Sviluppo/jhelly.juice/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_d1282aa377 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/fabiano/Sviluppo/jhelly.juice/temp/cache/latte');
